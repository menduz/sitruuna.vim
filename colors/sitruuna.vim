...
call s:HL('LineNr',          'selection',     'background')
call s:HL('FoldColumn',      'selection',     'background')
call s:HL('SignColumn',      'selection',     'background')
...
call s:HL('Statement',       'foreground', 'none')
